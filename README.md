...
2. **Plumb seats** — paid ready desk hunt software you self-host (Starter / Pro / Source). **Telegram control** — menus, reports, eyes. **We build; you continue** — elghaly delivers bot + walkthrough; buyer operates after. As-is, no profit guarantees. No free seats. Titan/gRPC quoted separately after brief.
